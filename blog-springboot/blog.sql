...
-- ----------------------------
INSERT INTO `tb_article` VALUES (1, 1, 190, 'http://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/articles/6925731385f4cab42c7fdeaad5e3a8da.jpg', '项目介绍', '##  1.技术介绍\n**前端**：vue + vuex + vue-router + axios + vuetify + elementui\n\n**后端**：SpringBoot + nginx + docker + SpringSecurity + Swagger2 + MyBatisPlus + Mysql + Redis + elasticsearch + rabbitMQ + MaxWell\n\n## 2.开发环境\n\n|开发工具|说明|\n|-|-|-|\n|IDEA|后端开发工具|\n|VSCode|前端开发工具|\n|Linux|系统部署环境|\n\n\n|开发环境|版本|\n|-|-|-|\n|JDK|1.8|\n|MySQL|8.0.28|\n|Redis|6.0.5|\n|Elasticsearch|7.9.2|\n|RabbitMQ|3.8.5|\n\n## 3.项目特点\n- 前台参考\"Hexo\"的\"Butterfly\"设计，美观简洁，响应式体验好。\n- 后台参考\"element-admin\"设计，侧边栏，历史标签，面包屑自动生成。\n- 采用Markdown编辑器，写法简单。\n- 评论支持表情输入回复等，样式参考Valine。\n- 添加音乐播放器，支持在线搜索歌曲。\n- 前后端分离部署，适应当前潮流。\n- 接入第三方登录，减少注册成本。\n- 支持发布说说，随时分享趣事。\n- 留言采用弹幕墙，更加炫酷。\n- 支持代码高亮和复制，图片预览，深色模式等功能，提升用户体验。\n- 搜索文章支持高亮分词，响应速度快。\n- 新增文章目录、推荐文章等功能，优化用户体验。\n- 新增在线聊天室，支持撤回、语音输入、统计未读数量等功能。\n- 新增aop注解实现日志管理。\n- 后台管理支持修改背景图片，博客配置等信息，操作简单，支持上传相册。\n- 代码支持多种搜索模式（Elasticsearch或MYSQL），支持多种上传模式（OSS或本地），可支持配置。\n- 代码遵循阿里巴巴开发规范，利于开发者学习。', 1, '', 0, 0, 1, '2022-05-24 20:43:29', '2022-05-24 20:50:07');
INSERT INTO `tb_article` VALUES (2, 1, 193, 'http://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/articles/246248b774ca4e9282312315f0560dee.jpg', '项目部署', '## 1.运行环境\n服务器：阿里云服务器\n存储系统：阿里云OSS\n服务器系统：CentOS7\n\n## 2.项目部署\n通过编写Dockerfile打包镜像，再通过docker-compose进行镜像命令编排部署项目\n\n## 3.项目开源\n通过首页GitHub图标跳转源码地址', 1, '', 0, 0, 1, '2022-05-24 21:09:04', NULL);
...
-- ----------------------------
INSERT INTO `tb_article_tag` VALUES (858, 1, 30);
INSERT INTO `tb_article_tag` VALUES (859, 1, 33);
INSERT INTO `tb_article_tag` VALUES (860, 1, 35);
INSERT INTO `tb_article_tag` VALUES (861, 2, 30);
INSERT INTO `tb_article_tag` VALUES (862, 2, 33);
...
-- ----------------------------
INSERT INTO `tb_category` VALUES (188, '学习资源', '2022-05-24 20:44:52', NULL);
INSERT INTO `tb_category` VALUES (189, '工具网站', '2022-05-24 20:45:04', NULL);
INSERT INTO `tb_category` VALUES (190, '日志随笔', '2022-05-24 20:45:12', NULL);
INSERT INTO `tb_category` VALUES (191, '备忘清单', '2022-05-24 20:45:18', NULL);
INSERT INTO `tb_category` VALUES (192, '解决方案', '2022-05-24 20:45:24', NULL);
INSERT INTO `tb_category` VALUES (193, '案例教程', '2022-05-24 20:45:32', NULL);
...
-- ----------------------------
INSERT INTO `tb_friend_link` VALUES (27, '郭奉孝的博客园', 'https://s1.ax1x.com/2022/04/05/qOFJS0.jpg', 'https://www.cnblogs.com/codegzy/', '曾经写博客的地址', '2022-05-25 20:42:52', NULL);
INSERT INTO `tb_friend_link` VALUES (28, '郭奉孝CSDN', 'https://z3.ax1x.com/2021/11/09/ItybcR.jpg', 'https://blog.csdn.net/qq_45420042', 'CSDN地址', '2022-05-25 20:46:41', '2022-05-25 20:47:53');
...
INSERT INTO `tb_operation_log` VALUES (1084, '文章模块', '新增或修改', '/admin/articles', 'top.codegzy.blog.controller.ArticleController.saveOrUpdateArticle', '添加或修改文章', '[{\"articleContent\":\"##  1.技术介绍\\n**前端**：vue + vuex + vue-router + axios + vuetify + elementui\\n\\n**后端**：SpringBoot + nginx + docker + SpringSecurity + Swagger2 + MyBatisPlus + Mysql + Redis + elasticsearch + rabbitMQ + MaxWell\\n\\n## 2.开发环境\\n\\n|开发工具|说明|\\n|-|-|-|\\n|IDEA|后端开发工具|\\n|VSCode|前端开发工具|\\n|Linux|系统部署环境|\\n\\n\\n|开发环境|版本|\\n|-|-|-|\\n|JDK|1.8|\\n|MySQL|8.0.28|\\n|Redis|6.0.5|\\n|Elasticsearch|7.9.2|\\n|RabbitMQ|3.8.5|\\n\\n## 3.项目特点\\n- 前台参考\\\"Hexo\\\"的\\\"Butterfly\\\"设计，美观简洁，响应式体验好。\\n- 后台参考\\\"element-admin\\\"设计，侧边栏，历史标签，面包屑自动生成。\\n- 采用Markdown编辑器，写法简单。\\n- 评论支持表情输入回复等，样式参考Valine。\\n- 添加音乐播放器，支持在线搜索歌曲。\\n- 前后端分离部署，适应当前潮流。\\n- 接入第三方登录，减少注册成本。\\n- 支持发布说说，随时分享趣事。\\n- 留言采用弹幕墙，更加炫酷。\\n- 支持代码高亮和复制，图片预览，深色模式等功能，提升用户体验。\\n- 搜索文章支持高亮分词，响应速度快。\\n- 新增文章目录、推荐文章等功能，优化用户体验。\\n- 新增在线聊天室，支持撤回、语音输入、统计未读数量等功能。\\n- 新增aop注解实现日志管理。\\n- 后台管理支持修改背景图片，博客配置等信息，操作简单，支持上传相册。\\n- 代码支持多种搜索模式（Elasticsearch或MYSQL），支持多种上传模式（OSS或本地），可支持配置。\\n- 代码遵循阿里巴巴开发规范，利于开发者学习。\",\"articleCover\":\"\",\"articleTitle\":\"项目介绍\",\"isTop\":0,\"originalUrl\":\"\",\"status\":3,\"tagNameList\":[],\"type\":1}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-24 20:43:29', NULL);
INSERT INTO `tb_operation_log` VALUES (1085, '分类模块', '新增或修改', '/admin/categories', 'top.codegzy.blog.controller.CategoryController.saveOrUpdateCategory', '添加或修改分类', '[{\"categoryName\":\"学习资源\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-24 20:44:52', NULL);
INSERT INTO `tb_operation_log` VALUES (1086, '分类模块', '新增或修改', '/admin/categories', 'top.codegzy.blog.controller.CategoryController.saveOrUpdateCategory', '添加或修改分类', '[{\"categoryName\":\"工具网站\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-24 20:45:04', NULL);
INSERT INTO `tb_operation_log` VALUES (1087, '分类模块', '新增或修改', '/admin/categories', 'top.codegzy.blog.controller.CategoryController.saveOrUpdateCategory', '添加或修改分类', '[{\"categoryName\":\"日志随笔\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-24 20:45:12', NULL);
INSERT INTO `tb_operation_log` VALUES (1088, '分类模块', '新增或修改', '/admin/categories', 'top.codegzy.blog.controller.CategoryController.saveOrUpdateCategory', '添加或修改分类', '[{\"categoryName\":\"备忘清单\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-24 20:45:19', NULL);
INSERT INTO `tb_operation_log` VALUES (1089, '分类模块', '新增或修改', '/admin/categories', 'top.codegzy.blog.controller.CategoryController.saveOrUpdateCategory', '添加或修改分类', '[{\"categoryName\":\"解决方案\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-24 20:45:25', NULL);
INSERT INTO `tb_operation_log` VALUES (1090, '分类模块', '新增或修改', '/admin/categories', 'top.codegzy.blog.controller.CategoryController.saveOrUpdateCategory', '添加或修改分类', '[{\"categoryName\":\"案例教程\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-24 20:45:33', NULL);
INSERT INTO `tb_operation_log` VALUES (1091, '标签模块', '新增或修改', '/admin/tags', 'top.codegzy.blog.controller.TagController.saveOrUpdateTag', '添加或修改标签', '[{\"tagName\":\"SpringBoot\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-24 20:45:44', NULL);
INSERT INTO `tb_operation_log` VALUES (1092, '标签模块', '新增或修改', '/admin/tags', 'top.codegzy.blog.controller.TagController.saveOrUpdateTag', '添加或修改标签', '[{\"tagName\":\"Go\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-24 20:45:51', NULL);
INSERT INTO `tb_operation_log` VALUES (1093, '标签模块', '新增或修改', '/admin/tags', 'top.codegzy.blog.controller.TagController.saveOrUpdateTag', '添加或修改标签', '[{\"tagName\":\"JavaScript\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-24 20:46:14', NULL);
INSERT INTO `tb_operation_log` VALUES (1094, '标签模块', '新增或修改', '/admin/tags', 'top.codegzy.blog.controller.TagController.saveOrUpdateTag', '添加或修改标签', '[{\"tagName\":\"Vue\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-24 20:46:19', NULL);
INSERT INTO `tb_operation_log` VALUES (1095, '标签模块', '新增或修改', '/admin/tags', 'top.codegzy.blog.controller.TagController.saveOrUpdateTag', '添加或修改标签', '[{\"tagName\":\"Micro Service\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-24 20:47:02', NULL);
INSERT INTO `tb_operation_log` VALUES (1096, '标签模块', '新增或修改', '/admin/tags', 'top.codegzy.blog.controller.TagController.saveOrUpdateTag', '添加或修改标签', '[{\"tagName\":\"DataBase\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-24 20:47:21', NULL);
INSERT INTO `tb_operation_log` VALUES (1097, '文章模块', '新增或修改', '/admin/articles', 'top.codegzy.blog.controller.ArticleController.saveOrUpdateArticle', '添加或修改文章', '[{\"articleContent\":\"##  1.技术介绍\\n**前端**：vue + vuex + vue-router + axios + vuetify + elementui\\n\\n**后端**：SpringBoot + nginx + docker + SpringSecurity + Swagger2 + MyBatisPlus + Mysql + Redis + elasticsearch + rabbitMQ + MaxWell\\n\\n## 2.开发环境\\n\\n|开发工具|说明|\\n|-|-|-|\\n|IDEA|后端开发工具|\\n|VSCode|前端开发工具|\\n|Linux|系统部署环境|\\n\\n\\n|开发环境|版本|\\n|-|-|-|\\n|JDK|1.8|\\n|MySQL|8.0.28|\\n|Redis|6.0.5|\\n|Elasticsearch|7.9.2|\\n|RabbitMQ|3.8.5|\\n\\n## 3.项目特点\\n- 前台参考\\\"Hexo\\\"的\\\"Butterfly\\\"设计，美观简洁，响应式体验好。\\n- 后台参考\\\"element-admin\\\"设计，侧边栏，历史标签，面包屑自动生成。\\n- 采用Markdown编辑器，写法简单。\\n- 评论支持表情输入回复等，样式参考Valine。\\n- 添加音乐播放器，支持在线搜索歌曲。\\n- 前后端分离部署，适应当前潮流。\\n- 接入第三方登录，减少注册成本。\\n- 支持发布说说，随时分享趣事。\\n- 留言采用弹幕墙，更加炫酷。\\n- 支持代码高亮和复制，图片预览，深色模式等功能，提升用户体验。\\n- 搜索文章支持高亮分词，响应速度快。\\n- 新增文章目录、推荐文章等功能，优化用户体验。\\n- 新增在线聊天室，支持撤回、语音输入、统计未读数量等功能。\\n- 新增aop注解实现日志管理。\\n- 后台管理支持修改背景图片，博客配置等信息，操作简单，支持上传相册。\\n- 代码支持多种搜索模式（Elasticsearch或MYSQL），支持多种上传模式（OSS或本地），可支持配置。\\n- 代码遵循阿里巴巴开发规范，利于开发者学习。\",\"articleCover\":\"http://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/articles/6925731385f4cab42c7fdeaad5e3a8da.jpg\",\"articleTitle\":\"项目介绍\",\"categoryName\":\"日志随笔\",\"id\":55,\"isTop\":0,\"originalUrl\":\"\",\"status\":1,\"tagNameList\":[],\"type\":1}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-24 20:50:07', NULL);
INSERT INTO `tb_operation_log` VALUES (1098, '文章模块', '新增或修改', '/admin/articles', 'top.codegzy.blog.controller.ArticleController.saveOrUpdateArticle', '添加或修改文章', '[{\"articleContent\":\"## 1.运行环境\\n服务器：阿里云服务器\\n存储系统：阿里云OSS\\n服务器系统：CentOS7\\n\\n## 2.项目部署\\n通过编写Dockerfile打包镜像，再通过docker-compose进行镜像命令编排部署项目\\n\\n## 3.项目开源\\n通过首页GitHub图标跳转源码地址\",\"articleCover\":\"http://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/articles/246248b774ca4e9282312315f0560dee.jpg\",\"articleTitle\":\"项目部署\",\"categoryName\":\"案例教程\",\"isTop\":0,\"originalUrl\":\"\",\"status\":1,\"tagNameList\":[],\"type\":1}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-24 21:09:04', NULL);
INSERT INTO `tb_operation_log` VALUES (1099, '相册模块', '新增或修改', '/admin/photos/albums', 'top.codegzy.blog.controller.PhotoAlbumController.saveOrUpdatePhotoAlbum', '保存或更新相册', '[{\"albumCover\":\"http://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/photos/713a0d085436cc7b9d28e8a3bbb24bcf.jpg\",\"albumDesc\":\"二次元\",\"albumName\":\"个人相册\",\"status\":1}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-24 22:40:04', NULL);
INSERT INTO `tb_operation_log` VALUES (1100, '照片模块', '新增', '/admin/photos', 'top.codegzy.blog.controller.PhotoController.savePhotos', '保存照片', '[{\"albumId\":8,\"photoUrlList\":[\"http://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/photos/7170937ecbdf6c5d86fbbaa26c62cf19.jpg\",\"http://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/photos/d4af92468a0f01fa7db094288a90d5c2.jpg\"]}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-24 22:40:18', NULL);
INSERT INTO `tb_operation_log` VALUES (1101, '博客信息模块', '修改', '/admin/about', 'top.codegzy.blog.controller.BlogInfoController.updateAbout', '修改关于我信息', '[{\"aboutContent\":\"<div style=\\\"text-align:center;font-size:24px;font-family: sans-serif;font-weight:700;margin:8rem auto;\\\">四年时光白驹过隙，<br>辛酸苦辣犹未可知。<br>回忆过往犹如昨日，<br>憧憬未来可有作为？</div>\\n\"}]', 'PUT', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-25 19:29:39', NULL);
INSERT INTO `tb_operation_log` VALUES (1102, '博客信息模块', '修改', '/admin/about', 'top.codegzy.blog.controller.BlogInfoController.updateAbout', '修改关于我信息', '[{\"aboutContent\":\"<div style=\\\"text-align:center;font-size:24px;font-family: sans-serif;font-weight:700;margin:6rem auto;\\\">\\n四年时光白驹过隙，<br>辛酸苦辣犹未可知。<br>回忆过往犹如昨日，<br>憧憬未来可有作为？</div>\\n\"}]', 'PUT', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-25 19:33:08', NULL);
INSERT INTO `tb_operation_log` VALUES (1103, '博客信息模块', '修改', '/admin/about', 'top.codegzy.blog.controller.BlogInfoController.updateAbout', '修改关于我信息', '[{\"aboutContent\":\"<div style=\\\"text-align:center;font-size:24px;font-family: sans-serif;font-weight:700;margin:6rem auto;\\\">\\n四年时光白驹过隙<br>辛酸苦辣犹未可知<br>回忆过往犹如昨日<br>憧憬未来可有作为</div>\\n\"}]', 'PUT', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-25 20:40:18', NULL);
INSERT INTO `tb_operation_log` VALUES (1104, '博客信息模块', '修改', '/admin/about', 'top.codegzy.blog.controller.BlogInfoController.updateAbout', '修改关于我信息', '[{\"aboutContent\":\"<div style=\\\"text-align:center;font-size:24px;font-family: sans-serif;font-weight:700;margin:6rem auto;\\\">\\n<p style=\\\"margin-top:1rem;display:inline-block;\\\">郭奉孝</p><br>\\n四年时光白驹过隙<br>辛酸苦辣犹未可知<br>回忆过往犹如昨日<br>憧憬未来可有作为</div>\\n\"}]', 'PUT', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-25 20:41:29', NULL);
INSERT INTO `tb_operation_log` VALUES (1105, '友链模块', '新增或修改', '/admin/links', 'top.codegzy.blog.controller.FriendLinkController.saveOrUpdateFriendLink', '保存或修改友链', '[{\"linkAddress\":\"https://www.cnblogs.com/codegzy/\",\"linkAvatar\":\"https://s1.ax1x.com/2022/04/05/qOFJS0.jpg\",\"linkIntro\":\"曾经写博客的地址\",\"linkName\":\"郭奉孝的博客园\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-25 20:42:52', NULL);
INSERT INTO `tb_operation_log` VALUES (1106, '友链模块', '新增或修改', '/admin/links', 'top.codegzy.blog.controller.FriendLinkController.saveOrUpdateFriendLink', '保存或修改友链', '[{\"linkAddress\":\"https://blog.csdn.net/qq_45420042\",\"linkAvatar\":\"https://profile.csdnimg.cn/D/C/D/1_qq_45420042\",\"linkIntro\":\"CSDN地址\",\"linkName\":\"郭奉孝CSDN\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-25 20:46:41', NULL);
INSERT INTO `tb_operation_log` VALUES (1107, '友链模块', '新增或修改', '/admin/links', 'top.codegzy.blog.controller.FriendLinkController.saveOrUpdateFriendLink', '保存或修改友链', '[{\"id\":28,\"linkAddress\":\"https://blog.csdn.net/qq_45420042\",\"linkAvatar\":\"https://z3.ax1x.com/2021/11/09/ItybcR.jpg\",\"linkIntro\":\"CSDN地址\",\"linkName\":\"郭奉孝CSDN\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-25 20:47:53', NULL);
INSERT INTO `tb_operation_log` VALUES (1108, '页面模块', '新增或修改', '/admin/pages', 'top.codegzy.blog.controller.PageController.saveOrUpdatePage', '保存或更新页面', '[{\"id\":1,\"pageCover\":\"https://s1.ax1x.com/2022/05/24/XP20xO.jpg\",\"pageLabel\":\"home\",\"pageName\":\"首页\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-05-25 20:48:25', NULL);
...
-- Records of tb_page
-- ----------------------------
INSERT INTO `tb_page` VALUES (1, '首页', 'home', 'https://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/config/021f62be30cd7cd500b60330b29f5d22.jpg', '2021-08-07 10:32:36', '2022-05-25 20:48:25');
INSERT INTO `tb_page` VALUES (2, '归档', 'archive', 'https://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/photos/LS5t4U.jpg', '2021-08-07 10:32:36', '2021-10-04 15:43:14');
INSERT INTO `tb_page` VALUES (3, '分类', 'category', 'https://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/photos/461140aab2d6e0963ec92d92b0f15a52.jpg', '2021-08-07 10:32:36', '2021-10-04 15:43:31');
INSERT INTO `tb_page` VALUES (4, '标签', 'tag', 'https://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/photos/d4af92468a0f01fa7db094288a90d5c2.jpg', '2021-08-07 10:32:36', '2021-10-04 15:43:38');
INSERT INTO `tb_page` VALUES (5, '相册', 'album', 'https://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/photos/IGJUmt.jpg', '2021-08-07 10:32:36', '2021-12-27 12:23:12');
INSERT INTO `tb_page` VALUES (6, '友链', 'link', 'https://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/photos/230428-16231646686891.jpg', '2021-08-07 10:32:36', '2021-10-04 15:44:02');
INSERT INTO `tb_page` VALUES (7, '关于', 'about', 'https://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/photos/232902-16348301422b2a.jpg', '2021-08-07 10:32:36', '2021-10-04 15:44:08');
INSERT INTO `tb_page` VALUES (8, '留言', 'message', 'https://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/photos/174855-1497088135bff2.jpg', '2021-08-07 10:32:36', '2021-10-04 16:11:45');
INSERT INTO `tb_page` VALUES (9, '个人中心', 'user', 'https://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/photos/231636-1607354196f41e.jpg', '2021-08-07 10:32:36', '2021-10-04 15:45:17');
INSERT INTO `tb_page` VALUES (10, '文章列表', 'articleList', 'https://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/photos/211926-1506431966f1d3.jpg', '2021-08-10 15:36:19', '2021-10-04 15:45:45');
INSERT INTO `tb_page` VALUES (904, '说说', 'talk', 'https://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/photos/LS5rHx.jpg', '2022-01-23 00:51:24', '2022-01-23 03:01:21');
...
-- Records of tb_photo
-- ----------------------------
INSERT INTO `tb_photo` VALUES (29, 8, '1529110042211536898', NULL, 'http://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/photos/7170937ecbdf6c5d86fbbaa26c62cf19.jpg', 0, '2022-05-24 22:40:18', NULL);
INSERT INTO `tb_photo` VALUES (30, 8, '1529110042211536899', NULL, 'http://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/photos/d4af92468a0f01fa7db094288a90d5c2.jpg', 0, '2022-05-24 22:40:18', NULL);
...
-- ----------------------------
INSERT INTO `tb_photo_album` VALUES (8, '个人相册', '二次元', 'http://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/photos/713a0d085436cc7b9d28e8a3bbb24bcf.jpg', 0, 1, '2022-05-24 22:40:04', NULL);
...
-- Records of tb_tag
-- ----------------------------
INSERT INTO `tb_tag` VALUES (30, 'SpringBoot', '2022-05-24 20:45:44', NULL);
INSERT INTO `tb_tag` VALUES (31, 'Go', '2022-05-24 20:45:51', NULL);
INSERT INTO `tb_tag` VALUES (32, 'JavaScript', '2022-05-24 20:46:14', NULL);
INSERT INTO `tb_tag` VALUES (33, 'Vue', '2022-05-24 20:46:19', NULL);
INSERT INTO `tb_tag` VALUES (34, 'Micro Service', '2022-05-24 20:47:02', NULL);
INSERT INTO `tb_tag` VALUES (35, 'DataBase', '2022-05-24 20:47:21', NULL);
...
-- Records of tb_talk
-- ----------------------------
INSERT INTO `tb_talk` VALUES (49, 1, '祝大家开心快乐!', NULL, 0, 1, '2022-01-24 23:34:59', NULL);
...
-- ----------------------------
INSERT INTO `tb_user_auth` VALUES (1, 1, 'gzy@qq.com', '$2a$10$AkxkZaqcxEXdiNE1nrgW1.ms3aS9C5ImXMf8swkWUJuFGMqDl.TPW', 1, '127.0.0.1', '', '2021-08-12 15:43:18', '2022-05-25 21:16:44', '2022-05-25 21:16:44');
...
-- ----------------------------
INSERT INTO `tb_user_info` VALUES (1, 'gzy@qq.com', '管理员', 'http://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/avatar/68f14c16671f38e6338679d598e68f74.jpg', 'gzy@qq.com', NULL, 0, '2021-08-12 15:43:17', '2022-05-25 21:41:49');
...
-- ----------------------------
INSERT INTO `tb_website_config` VALUES (1, '{\"alipayQRCode\":\"https://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/avatar/qrcode_chrome.png\",\"gitee\":\"\",\"github\":\"https://github.com/gzy2570713180/blog\",\"isChatRoom\":1,\"isCommentReview\":0,\"isEmailNotice\":1,\"isMessageReview\":0,\"isMusicPlayer\":1,\"isReward\":1,\"qq\":\"2570713180\",\"socialLoginList\":[\"qq\",\"weibo\"],\"socialUrlList\":[\"qq\",\"github\",\"gitee\"],\"touristAvatar\":\"https://s1.ax1x.com/2022/05/24/XPQ7sH.jpg\",\"userAvatar\":\"https://s1.ax1x.com/2022/05/24/XPQ7sH.jpg\",\"websiteAuthor\":\"郭奉孝\",\"websiteAvatar\":\"http://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/config/68f14c16671f38e6338679d598e68f74.jpg\",\"websiteCreateTime\":\"2022-4-1\",\"websiteIntro\":\"努力,奋斗!\",\"websiteName\":\"Utopia\",\"websiteNotice\":\"项目开源\",\"websiteRecordNo\":\"皖公网安备 34010402703562号\",\"websocketUrl\":\"ws://127.0.0.1:8080/websocket\",\"weiXinQRCode\":\"https://gzy-person-data.oss-cn-hangzhou.aliyuncs.com/avatar/qrcode_chrome.png\"}', '2021-08-09 19:37:30', '2022-01-18 00:25:47');
